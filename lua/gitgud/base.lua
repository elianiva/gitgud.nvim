...
local get_spec = function(theme)
  local c = get_palette(theme)
  ...
  return lush(function()
    return {
      ...
      TSParameter           { fg = c.fg }, -- parameters of a function.
      ...
      TSVariable            { bg = "NONE", fg = c.fg },    -- Any variable name that does not have another highlight.
      ...
      NvimTreeNormal              { fg = c.fg.da(5), bg = c.bg.da(20) },
